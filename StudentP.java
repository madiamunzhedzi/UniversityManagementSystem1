...
public class StudentP extends javax.swing.JFrame {
    ...
    public StudentP(String studentUsername) {
    ...
    private void populateStudentInfo() {
        try {
            ...
            String query = "SELECT * FROM students1 WHERE uname = '" + studentUsername + "'";
            ResultSet rs = stmt.executeQuery(query);
            if (rs.next()) {
                jLabel10.setText(rs.getString("name"));
                jLabel11.setText(rs.getString("dateofbirth"));
                jLabel12.setText(rs.getString("address"));
                jLabel13.setText(rs.getString("gender"));
                jLabel14.setText(rs.getString("number"));
                jLabel15.setText(rs.getString("course"));
                jLabel16.setText(rs.getString("uname"));
